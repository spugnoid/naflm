 ...
 * Prints both Teams with skills and stats and postions to one Letter (RP) Page in landscape.
 *
 */
...
class PDFMatchReport implements ModuleInterface
{
    ...
    public static function main($argv)
    {
        ...
        $scoreboxOffset = 20;
        $pdf->RoundedRect($currentx + 100, $currenty + $scoreboxOffset, 50, 50, 5, 'D'); // score boxes
        $pdf->RoundedRect($currentx + 620, $currenty + $scoreboxOffset, 50, 50, 5, 'D'); // score boxes
        if ($FILLED) {
        ...
        while ($i < 2) {
            ...
            $pdf->Cell($statFieldSize, $h, 'No.', 1, 0, 'C', true, '');
            ...
            $pdf->Cell($statFieldSize, $h, 'No.', 1, 0, 'C', true, ''); // My addition - RP
